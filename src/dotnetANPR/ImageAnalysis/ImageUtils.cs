...
using SkiaSharp;
    ...
    {
        /// <summary>
        /// Gets brightness (Value) from an SKColor.
        /// Skia HSV values are H: 0-360, S: 0-100, V: 0-100.
        /// We convert to 0-1 range to match Java's HSB.
        /// </summary>
        ...
        /// This replaces java.awt.image.ConvolveOp.
        /// </summary>
        public static SKBitmap Convolve(SKBitmap src, float[] kernel, int kernelWidth, int kernelHeight)
        {
            ...
            // Skia applies convolution using an SKPaint and drawing.
            // We need a destination bitmap to draw onto.
            var result = new SKBitmap(src.Info);
            using var canvas = new SKCanvas(result);
            
            // kernel, kernelSize, offset, tileMode, convolveAlpha
