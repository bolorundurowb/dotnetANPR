...
public class Intelligence
{
    ...
    public string? Recognize(CarSnapshot carSnapshot, ReportGenerator? reportGenerator = null)
    {
        ...
        if (generateReport)
        {
            ...
            reportGenerator.InsertImage(carSnapshot.GetSKBitmapWithAxes(), "snapshot", 0, 0);
        }
        ...
        foreach (var band in carSnapshot.Bands())
        {
            ...
            foreach (var plate in band.Plates())
            {
                ...
                if (generateReport)
                {
                    ...
                    reportGenerator.InsertImage(band.GetSKBitmapWithAxes(), "band", 0, 0);
                    ...
                    reportGenerator.InsertImage(plateCopy.GetSKBitmapWithAxes(), "plate", 0, 0);
